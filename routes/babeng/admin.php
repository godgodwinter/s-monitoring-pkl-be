...
Route::middleware('babeng:adminOwner')->group(function () {
    ...
    Route::post('/admin/tagihan/add/{kelas}', [adminTagihanController::class, 'store_kelas']);
    ...
    // Route::delete('/admin/tagihan/null/pembayaran/{pembayaran}', [adminTagihanController::class, 'destroy_pembayaran']);
